...
def run(in_q):
    ...
    chrome = webdriver.Chrome(executable_path=r"C:\Users\13058\AppData\Local\Google\Chrome\Application\chromedriver",
                              options=opt)
